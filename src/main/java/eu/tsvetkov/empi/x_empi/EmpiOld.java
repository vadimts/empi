...
import eu.tsvetkov.empi.x_empi.command.move.Capitalize;
import eu.tsvetkov.empi.x_empi.command.move.RenameClear;
import eu.tsvetkov.empi.x_empi.command.move.RenameRegex;
import eu.tsvetkov.empi.x_empi.command.tag.*;
